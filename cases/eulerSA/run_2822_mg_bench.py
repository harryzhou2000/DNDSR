"""Run the RAE 2822 multigrid convergence sweep.

Invoke this driver from the DNDSR build directory. Use ``--dry-run`` to inspect
the 32-rank solver commands and output paths before a local or scheduled run.
"""
