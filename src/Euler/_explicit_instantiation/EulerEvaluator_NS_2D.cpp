...
namespace DNDS::Euler
{
    ...
    template void EulerEvaluator<NS_2D>::LUSGSMatrixVec(
        real alphaDiag,
        ArrayDOFV<nVars_Fixed> &u,
    ...
    template void EulerEvaluator<NS_2D>::UpdateLUSGSForward(
        real alphaDiag,
    ...
    template void EulerEvaluator<NS_2D>::UpdateLUSGSBackward(
        real alphaDiag,
        ArrayDOFV<nVars_Fixed> &rhs,
        ArrayDOFV<nVars_Fixed> &u,
        ArrayDOFV<nVars_Fixed> &uInc,
